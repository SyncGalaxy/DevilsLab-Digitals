...
export default function QuotationPage() {
    ...
    const services: Service[] = [
        { id: 'surge', name: 'Surge System', price: 790, category: 'flagship' },
        { id: 'static', name: 'Static Website', price: 263, category: 'web' },
        { id: 'dynamic', name: 'Dynamic Website', price: 632, category: 'web' },
        { id: 'saas-mvp', name: 'SaaS MVP', price: 1580, category: 'saas' },
        { id: 'saas-scalable', name: 'Scalable SaaS Platform', price: 4213, category: 'saas' },
        { id: 'web3-integration', name: 'Web3 Integration', price: 1053, category: 'web3' },
        { id: 'web3-platform', name: 'Full Web3 Platform', price: 2633, category: 'web3' },
        { id: 'rnd', name: 'R&D (per month)', price: 790, category: 'rnd' }
    ];

    const isSurgeSelected = selectedServices['surge'] || false;
    const isDynamicSelected = selectedServices['dynamic'] || false;
    const LANDING_PAGE_CREDIT = 158;
                            ...
                            {isSurgeSelected && (
                                <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                    <p className="text-sm text-blue-800">
                                        <strong>Note:</strong> Surge System includes a $158 landing page. Static website option is not available. Dynamic website receives a $158 credit.
                                    </p>
                                </div>
                            )}
                        </div>
                                ...
                                {groupedServices.web.map((service) => {
                                    ...
                                    return (
                                        <div key={service.id}>
                                            ...
                                            {showDynamicCredit && (
                                                <p className="text-xs text-green-600 mt-1 ml-9 italic">$158 landing page credit applied from Surge System</p>
                                            )}
                                        </div>
                                    );
                                })}
